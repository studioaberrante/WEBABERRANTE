...
(function initHaloReel() {
  ...
  // Las tarjetas muestran solo su carátula; el video se abre al tocar
  // (modal). Sin reproductores girando, el anillo es liviano en móvil.
  if ('IntersectionObserver' in window) {
    new IntersectionObserver((entries) => { visible = entries[0].isIntersecting; }, { threshold: 0.15 }).observe(stage);
  }
